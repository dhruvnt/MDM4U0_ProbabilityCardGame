...
sheet1.write(0,2,'Points(Dealer)')
sheet1.write(0,3,'Points(Player)')
...
sheet1.write(0, 4, "TOTAL DEALER WINS")
sheet1.write(0, 5, "TOTAL PLAYER WINS")
sheet1.write(1, 4, dealer_wins)
sheet1.write(1, 5, player_wins)
